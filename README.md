...
Set `VITE_CLERK_PUBLISHABLE_KEY` and `VITE_API_URL` in the appropriate Vite
environment file (see `.env.example`). In the Clerk Dashboard, enable Google,
GitHub, and email/password sign-in; require email verification; enable password
reset; and register the exact development and production frontend origins and
